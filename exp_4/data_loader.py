...
class TextDataset(Dataset):
    def __init__(self, src_path, tgt_path, src_vocab_path, tgt_vocab_path, pad_token='<pad>', bos_token='<bos>', eos_token='<eos>', unk_token='<unk>'):
        # 加载词表
...
def get_dataloader(src_path, tgt_path, src_vocab_path, tgt_vocab_path, batch_size=32, shuffle=True):
